...
def main():
  ...
  plistpath = scriptpath + "/resources/CVDFreq-VST2-Info.plist"
  ...
  plistpath = scriptpath + "/resources/CVDFreq-AU-Info.plist"
  ...
  plistpath = scriptpath + "/resources/CVDFreq-VST3-Info.plist"
  ...
  plistpath = scriptpath + "/resources/CVDFreq-OSXAPP-Info.plist"
  ...
  plistpath = scriptpath + "/resources/CVDFreq-RTAS-Info.plist"
  ...
  plistpath = scriptpath + "/resources/CVDFreq-AAX-Info.plist"
...
#   plistpath = scriptpath + "/resources/CVDFreq-IOSAPP-Info.plist"
...
#   replacestrs(plistpath, "//Apple//", "//Apple Computer//");
  ...
  plistpath = scriptpath + "/installer/CVDFreq.pkgproj"
  ...
  for line in fileinput.input(scriptpath + "/installer/CVDFreq.iss",inplace=1):
